...
?>
		...
		<div class="footer-inside">
			...
			<div class="latest-tweets">
				...
				<script type="text/javascript" src="https://api.twitter.com/1/statuses/user_timeline/<?php echo $yam_twitter; ?>.json?callback=twitterCallback2&amp;count=<?php echo $yam_tweetsnr; ?>"></script>
			</div> <!-- latest-tweets -->
		...
		<div id="footer-credits">
			<div class="footer-credits-inside">
				...
				<div class="footer-credits-right">
					Powered by <a href="http://www.wordpress.org">Wordpress</a> - YAMINTH Theme by <a href="http://azmind.com" title="Free Wordpress Themes and Web Design Resources">Azmind.com</a>
				</div>
			</div>
		</div> <!-- footer-credits -->
