...
define('DB_NAME', 'pohanfong');

/** MySQL 資料庫使用者名稱，請更改 "username_here" */
define('DB_USER', 'root');

/** MySQL 資料庫密碼，請更改 "password_here" */
define('DB_PASSWORD', 'poka');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'pohanFengIsGod');
define('SECURE_AUTH_KEY',  'pohanFengIsGod');
define('LOGGED_IN_KEY',    'pohanFengIsGod');
define('NONCE_KEY',        'pohanFengIsGod');
define('AUTH_SALT',        'pohanFengIsGod');
define('SECURE_AUTH_SALT', 'pohanFengIsGod');
define('LOGGED_IN_SALT',   'pohanFengIsGod');
define('NONCE_SALT',       'pohanFengIsGod');
 ...
 * 預設儲存間隔為 60 秒。
 */
define('AUTOSAVE_INTERVAL', 30 );  // 單位：秒
